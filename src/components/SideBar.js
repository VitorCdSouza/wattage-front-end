...
const SideBar = () => (
    <div className="h-full max-w-[32rem] p-4 space-y-6 bg-neutral-900 text-white shadow-neutral-900 shadow-md">
...
const SideBarItem = (props) => (
    ...
    <Link to={props.to} className="hover:outline outline-1 outline-gray-700 hover:bg-gray-700 transition delay-[10ms] cursor-pointer p-2 sidebar-item flex mt-5 ms-5 ml-3 mr-6 rounded-md">
        {props.icon} <p className="ms-2 mt-[0.32rem] font-semibold">{props.name}</p>
    </Link>
)
